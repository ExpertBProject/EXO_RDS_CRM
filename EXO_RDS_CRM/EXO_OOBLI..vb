...
#Region "Inicialización"
    ...
    Private Sub cargaCampos()
        ...
        If objGlobal.refDi.comunes.esAdministrador Then
            ...
            sXML = objGlobal.funciones.leerEmbebido(Me.GetType(), "UDO_EXO_OOBLI.xml")
            objGlobal.SBOApp.StatusBar.SetText("Validando: UDO_EXO_OOBLI", SAPbouiCOM.BoMessageTime.bmt_Medium, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                        ...
                        Select Case oForm.ChooseFromLists.Item(oDataTable.ChooseFromListUID).ObjectType
                            Case "97"
                                Try
                                    ...
                                    oForm.DataSources.DBDataSources.Item("@EXO_OPORDOCO").SetValue("Name", 0, sDes)
                                Catch ex As Exception
                                    oForm.DataSources.DBDataSources.Item("@EXO_OPORDOCO").SetValue("Name", 0, sDes)
                                End Try
                        End Select
...
#End Region
    ...
    Private Sub CargarCombos(ByRef oForm As SAPbouiCOM.Form)
        ...
        Try
            CType(oForm.Items.Item("0_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_0_4").DisplayDesc = True
            CType(oForm.Items.Item("0_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_0_3").DisplayDesc = True
            sSQL = "SELECT ""SlpCode"",""SlpName"" FROM ""OSLP"" "
            ...
            CType(oForm.Items.Item("1_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_1_4").DisplayDesc = True
            CType(oForm.Items.Item("1_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_1_3").DisplayDesc = True
            objGlobal.funcionesUI.cargaCombo(CType(oForm.Items.Item("1_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_1_3").ValidValues, sSQL)

            CType(oForm.Items.Item("2_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_2_4").DisplayDesc = True
            CType(oForm.Items.Item("2_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_2_3").DisplayDesc = True
            objGlobal.funcionesUI.cargaCombo(CType(oForm.Items.Item("2_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_2_3").ValidValues, sSQL)

            CType(oForm.Items.Item("3_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_3_4").DisplayDesc = True
            CType(oForm.Items.Item("3_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_3_3").DisplayDesc = True
            objGlobal.funcionesUI.cargaCombo(CType(oForm.Items.Item("3_U_G").Specific, SAPbouiCOM.Matrix).Columns.Item("C_3_3").ValidValues, sSQL)
